...
public static class Generator
{
    ...
    public static PrintMode Generate(ulong ticks, Span<Item> result, PrintMode printMode)
    {
        var rand = new Xoroshiro128Plus(ticks);
        return Generate(ref rand, result, printMode);
    }

    public static PrintMode Generate(ref Xoroshiro128Plus rand, Span<Item> result, PrintMode printMode)
    {
        // Generate the result
    ...
    public static ulong FindNextBonusMode(ulong startTicks, PrintMode targetMode, int itemId = 0)
    {
        ...
        while (true)
        {
            var resultMode = Generate(startTicks, result, PrintMode.Regular);
